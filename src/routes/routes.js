...
const routes = [
  ...
  { path: "/business-details/:id", element: <BusinessDetails />, exact: "true", type: "public"},

  // { path: "/business", element: <Business />, exact: "true", type: "public" },

  { path: "/user-profile", element: <UserProfile />, exact: "true", type: "private" },

  { path: "/edit-user/:id", element: <EditUser />, exact: "true", type: "private" },

  { path: "/cat-details/:id", element: <CategoryDetails />, exact: "true", type: "private" },

  { path: "/business/:name/:id", element: <Businesses />, exact: "true", type: "public" },

  { path: "/business-listing", element: <BusinessListing />, exact: "true", type: "public" },
